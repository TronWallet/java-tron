...
public class HttpTestConstantContract001 {
  ...
  public void test4TriggerConstantContractFromSolidity() {
    ...
    String param = param1 + param2;
    logger.info(ByteArray.toHexString(assetOwnerAddress));
    response = HttpMethed.triggerConstantContractFromSolidity(httpSoliditynode, assetOwnerAddress, contractAddress,
        "testPure(uint256,uint256)",param, 1000000000L);
  ...
  public void test5TriggerConstantContractFromRealSolidity() {
    ...
    String param = param1 + param2;
    logger.info(ByteArray.toHexString(assetOwnerAddress));
    response = HttpMethed.triggerConstantContractFromSolidity(realHttpSoliditynode, assetOwnerAddress, contractAddress,
        "testPure(uint256,uint256)",param, 1000000000L);
